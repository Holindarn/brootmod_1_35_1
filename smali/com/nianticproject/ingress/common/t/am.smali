.class public final Lcom/nianticproject/ingress/common/t/am;
...
# static fields
.field private static final a:Lcom/nianticproject/ingress/common/t/am;
...
.field private final b:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Ljava/lang/String;",
            "Lcom/nianticproject/ingress/common/t/an;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 43
    new-instance v0, Lcom/nianticproject/ingress/common/t/am;

    invoke-direct {v0}, Lcom/nianticproject/ingress/common/t/am;-><init>()V

    sput-object v0, Lcom/nianticproject/ingress/common/t/am;->a:Lcom/nianticproject/ingress/common/t/am;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/nianticproject/ingress/common/t/am;->b:Ljava/util/Map;

    .line 294
    return-void
.end method

.method public static a()Lcom/nianticproject/ingress/common/t/am;
    .locals 1

    .prologue
    .line 46
    sget-object v0, Lcom/nianticproject/ingress/common/t/am;->a:Lcom/nianticproject/ingress/common/t/am;

    return-object v0
.end method

.method private static a(Ljava/util/Set;Ljava/util/Set;Lcom/nianticproject/ingress/common/t/an;Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorArray;Lcom/nianticproject/ingress/gameentity/components/SimplePortal;)V
    .locals 11
    .parameter
    .parameter
    .parameter
    ...
    .line 229
    iget-object v7, p2, Lcom/nianticproject/ingress/common/t/an;->a:[Ljava/lang/String;

    aget-object v7, v7, v6

    .line 230
    invoke-interface {p3, v0}, Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorArray;->getResonator(Lcom/nianticproject/ingress/shared/s;)Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorV2;
    ...
    .line 237
    iget-object v0, p2, Lcom/nianticproject/ingress/common/t/an;->a:[Ljava/lang/String;
    ...
    invoke-interface {p3}, Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorArray;->getEntity()Lcom/nianticproject/ingress/gameentity/GameEntity;

    move-result-object v7

    invoke-interface {v7}, Lcom/nianticproject/ingress/gameentity/GameEntity;->getLastModifiedMs()J
    ...
    invoke-interface {v8}, Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorV2;->getEntity()Lcom/nianticproject/ingress/gameentity/GameEntity;

    move-result-object v6

    const-class v7, Lcom/nianticproject/ingress/gameentity/components/ControllingTeam;

    invoke-interface {v6, v7}, Lcom/nianticproject/ingress/gameentity/GameEntity;->getComponent(Ljava/lang/Class;)Lcom/nianticproject/ingress/gameentity/a;
    ...
    .line 278
    iget-object v6, p2, Lcom/nianticproject/ingress/common/t/an;->a:[Ljava/lang/String;
    ...
    invoke-virtual {p4, v6, v7, v0, v5}, Lcom/nianticproject/ingress/gameentity/components/SimplePortal;->addLinkedResonator(Ljava/lang/String;ILcom/nianticproject/ingress/shared/s;Ljava/lang/String;)V
    ...
    .line 282
    :cond_5
    iget-object v5, p2, Lcom/nianticproject/ingress/common/t/an;->a:[Ljava/lang/String;
...
.method public final a(Lcom/nianticproject/ingress/shared/rpc/GameBasket;)V
    ...
    iget-object v4, v0, Lcom/nianticproject/ingress/common/t/am;->b:Ljava/util/Map;

    invoke-interface {v4, v2}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/nianticproject/ingress/common/t/an;

    .line 94
    if-eqz v2, :cond_0

    .line 97
    iget-object v4, v2, Lcom/nianticproject/ingress/common/t/an;->a:[Ljava/lang/String;
    ...
    .line 124
    invoke-interface {v2}, Lcom/nianticproject/ingress/gameentity/GameEntity;->getLastModifiedMs()J
    ...
    iget-object v5, v0, Lcom/nianticproject/ingress/common/t/am;->b:Ljava/util/Map;

    invoke-interface {v5, v12}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/nianticproject/ingress/common/t/an;

    .line 126
    if-eqz v5, :cond_4

    iget-wide v15, v5, Lcom/nianticproject/ingress/common/t/an;->b:J
    ...
    check-cast v5, Lcom/nianticproject/ingress/shared/n;

    invoke-interface {v3, v5}, Lcom/nianticproject/ingress/gameentity/components/portal/PortalV2;->getDescriptiveText(Lcom/nianticproject/ingress/shared/n;)Ljava/lang/String;

    move-result-object v17

    move-object/from16 v0, v17

    invoke-virtual {v15, v5, v0}, Lcom/nianticproject/ingress/gameentity/components/SimplePortal;->addOrUpdateDescriptiveText(Lcom/nianticproject/ingress/shared/n;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v3}, Lcom/nianticproject/ingress/gameentity/GameEntity;->remove(Ljava/lang/Class;)Lcom/nianticproject/ingress/gameentity/DynamicComponent;

    .line 134
    invoke-interface {v2, v15}, Lcom/nianticproject/ingress/gameentity/GameEntity;->add(Lcom/nianticproject/ingress/gameentity/DynamicComponent;)V

    .line 136
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/nianticproject/ingress/common/t/am;->b:Ljava/util/Map;
    ...
    check-cast v3, Lcom/nianticproject/ingress/common/t/an;

    invoke-static {v7, v8, v3, v4, v15}, Lcom/nianticproject/ingress/common/t/am;->a(Ljava/util/Set;Ljava/util/Set;Lcom/nianticproject/ingress/common/t/an;Lcom/nianticproject/ingress/gameentity/components/portal/ResonatorArray;Lcom/nianticproject/ingress/gameentity/components/SimplePortal;)V

    iput-wide v13, v3, Lcom/nianticproject/ingress/common/t/an;->b:J
    ...
    .line 136
    :cond_a
    new-instance v3, Lcom/nianticproject/ingress/common/t/an;

    const/4 v5, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v5}, Lcom/nianticproject/ingress/common/t/an;-><init>(Lcom/nianticproject/ingress/common/t/am;B)V
...
.method public final b()V
    ...
    .line 289
    :try_start_0
    iget-object v0, p0, Lcom/nianticproject/ingress/common/t/am;->b:Ljava/util/Map;
